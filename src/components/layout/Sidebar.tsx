...
import { Home, Users, Plus, Trophy, Calendar, ChevronLeft, ChevronRight, LogOut, LogIn, Settings, HelpCircle } from 'lucide-react';
  ...
  const navSections: NavSection[] = [
    {
      ...
      items: [
        ...
        ...(isAdmin ? [{ icon: Plus, label: 'New Match', path: '/match/new' }] : []),
